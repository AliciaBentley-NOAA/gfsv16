...
cat > ${DATA_PATH}/${CASE}/${CYCLE}/plot_refl_${REGIONNAME}_${CYCLE}.csh <<EOF
#!/bin/csh
#SBATCH --account=ovp
#SBATCH --job-name=${REGIONNAME}_refl_${CYCLE}
...
sbatch ${DATA_PATH}/${CASE}/${CYCLE}/plot_refl_${REGIONNAME}_${CYCLE}.csh
sleep 5
...
cat > ${DATA_PATH}/${CASE}/${CYCLE}/plot_refl_${DOMAIN}_${CYCLE}.sh <<EOF
#!/bin/bash
#SBATCH --account=ovp
#SBATCH --job-name=${DOMAIN}_refl_${CYCLE}
...
sbatch ${DATA_PATH}/${CASE}/${CYCLE}/plot_refl_${DOMAIN}_${CYCLE}.sh
sleep 5
